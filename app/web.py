...
PHONE_COUNTRY_CODE_OPTIONS = [
    ...
    ("+269", "Comoros (+269)"),
    ("+242", "Congo (+242)"),
    ("+243", "Congo, Democratic Republic (+243)"),
      ...
      widgets.forEach(function (widget) {
        ...
        function syncSelection() {
          ...
          if (!selectedValues.length) {
            summary.textContent = "Select up to 3 languages";
          ...
          counter.textContent = selectedValues.length ? selectedValues.length + " of " + maxSelection + " selected" : "Select up to " + maxSelection + " languages";
